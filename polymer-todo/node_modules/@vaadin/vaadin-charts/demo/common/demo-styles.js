...
$_documentContainer.innerHTML = `<dom-module id="demo-styles" theme-for="vaadin-chart">
  <template>
    <style include="vaadin-chart-default-theme">
        /* ERROR-BAR */
        :host([theme~="error-bar"]) .highcharts-tooltip .rainfallSeriesName {
          fill: #7cb5ec;
          font-weight: bold;
        }
        ...
        /* POLYGON */
        :host([theme~="polygon"]) .targetSeries {
          fill: rgba(97, 181, 236, 0.5);
          stroke: rgba(97, 181, 236, 0.5);
        }
        ...
        /* SOLID-GAUGE */
        :host([theme~="solidgauge"]) .highcharts-yaxis-grid .highcharts-grid-line {
          display: none;
        }
