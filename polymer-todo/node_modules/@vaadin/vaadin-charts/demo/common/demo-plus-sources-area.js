...
class DemoPlusSourcesArea extends PolymerElement {
  static get template() {
    return html`
    <style>
      :host {
    ...
    <div id="container">
      <div class="nav-panel">
        ...
        <paper-button id="htmlbutton" class="nav-panel__tabs__button" on-click="showSource" noink="" toggles="" source-type="html">HTML</paper-button>
        <paper-button id="javabutton" class="nav-panel__tabs__button" on-click="showSource" noink="" toggles="" source-type="java">Java</paper-button>
        <paper-button style="display:none;" id="closebutton" on-click="_close" noink="" icon="vaadin:close-circle-o">
