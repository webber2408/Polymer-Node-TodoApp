...
class ConfirmDialogBasicDemos extends DemoReadyEventEmitter(ElementDemo(PolymerElement)) {
  static get template() {
    return html`
    ...
    <vaadin-demo-snippet id="confirm-dialog-basic-demos-confirm-cancel">
      <template preserve-content="">
        <vaadin-button>Open dialog</vaadin-button>
        <vaadin-confirm-dialog cancel="" header="Confirm delete" confirm-text="Delete" confirm-theme="error primary">
    ...
    <vaadin-demo-snippet id="confirm-dialog-basic-demos-confirm-discard">
      <template preserve-content="">
        <vaadin-button>Open dialog</vaadin-button>
        <vaadin-confirm-dialog cancel="" reject="" header="Unsaved changes" confirm-text="Save" reject-text="Discard">
